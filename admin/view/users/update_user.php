          ...
          <div class="card-body">
            <form class="forms-sample" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" value="<?php echo $accUpdate['username'] ?>" name="username">
                <?php
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Email" value="<?php echo $accUpdate['email'] ?>" name="email">
                <?php
                if (isset($_POST['updateUser'])) {
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" id="exampleInputPassword4" placeholder="Password" value="<?php echo $accUpdate['password'] ?>" name="password">
                <?php
                if (isset($_POST['updateUser'])) {
              ...
              <button type="submit" class="btn btn-gradient-primary me-2" name="updateUser">Submit</button>
